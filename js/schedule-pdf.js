  ...
  for (let pageNum = 1; pageNum <= pdf.numPages; pageNum++) {
    ...
    Object.entries(rows).forEach(([day, rowItems]) => {
      ...
      groupByColumn(teachItems, byX, false).forEach(g => {
        // اسم المعلم يؤخذ كما استخرج من الـ PDF بالضبط، بدون أي تصحيح/مطابقة على قائمة المعلمين
        // (بعكس اسم المادة اللي نصححه لأنه من قائمة مواد محدودة ومعروفة سلفًا).
